...
### [14. 神经网络结构设计(Neural Network Structure Design)](#NNS)
* [Transformer](#Transformer)
* [图神经网络(GNN)](#GNN)

### [15. 模型压缩(Model Compression)](#ModelCompression)
* [知识蒸馏(Knowledge Distillation)](#KnowledgeDistillation)
* [剪枝(Pruning)](#Pruning)
* [量化(Quantization)](#Quantization)

### [16. 模型训练/泛化(Model Training/Generalization)](#ModelTraining)
...
### [19. 数据处理(Data Processing)](#DataProcessing)
...
### [21. 小样本学习/零样本学习/元学习(Few-shot/Zero-shot Learning)](#Few-shotLearning)

### [22. 持续学习(Continual Learning/Life-long Learning)](#ContinualLearning)

### [23. 视觉推理(Visual Reasoning)](#VisualReasoning)

### [24. 迁移学习/domain/自适应(Transfer Learning/Domain Adaptation)](#domain)

### [25. 度量学习(Metric Learning)](#MetricLearning)

### [26. 对比学习(Contrastive Learning)](#ContrastiveLearning)

### [27. 强化学习(Reinforcement Learning)](#RL)

### [28. 元学习(Meta Learning)](#MetaLearning)

### [29. 数据集(Dataset)](#Dataset)
...
Abstract Spatial-Temporal Reasoning via Probabilistic Abduction and Execution(【时空推理】通过概率绑架和执行进行抽象时空推理)
...
ACRE: Abstract Causal REasoning Beyond Covariation(【因果推理】ACRE：超越协方差的抽象因果推理)<br>
...
Bidirectional Projection Network for Cross Dimension Scene Understanding(【场景理解】双向投影网络，用于跨维度场景理解)<br>
