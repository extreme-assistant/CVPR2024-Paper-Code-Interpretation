...
### [15. 视觉推理/视觉问答(Visual Reasoning/VQA)](#VisualReasoning)

### [16. 神经网络结构设计(Neural Network Structure Design)](#NNS)
* [Transformer](#Transformer)
* [图神经网络(GNN)](#GNN)

### [17. 模型压缩(Model Compression)](#ModelCompression)
* [知识蒸馏(Knowledge Distillation)](#KnowledgeDistillation)
* [剪枝(Pruning)](#Pruning)
* [量化(Quantization)](#Quantization)

### [18. 模型训练/泛化(Model Training/Generalization)](#ModelTraining)
* [噪声标签(Noisy Label)](#NoisyLabel)

### [19. 模型评估(Model Evaluation)](#ModelEvaluation)
...
### [22. 主动学习(Active Learning)](#ActiveLearning)

### [23. 小样本学习/零样本学习/元学习(Few-shot/Zero-shot Learning)](#Few-shotLearning)

### [24. 持续学习(Continual Learning/Life-long Learning)](#ContinualLearning)

### [25. 迁移学习/domain/自适应(Transfer Learning/Domain Adaptation)](#domain)

### [26. 度量学习(Metric Learning)](#MetricLearning)

### [27. 对比学习(Contrastive Learning)](#ContrastiveLearning)

### [28. 强化学习(Reinforcement Learning)](#RL)

### [29. 元学习(Meta Learning)](#MetaLearning)

### [30. 数据集(Dataset)](#Dataset)
...
Distribution Alignment: A Unified Framework for Long-tail Visual Recognition(【长尾分布】分布对齐：长尾视觉识别的统一框架)<br>
