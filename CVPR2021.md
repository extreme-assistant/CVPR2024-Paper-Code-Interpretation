...
### [7. GAN/生成式/对抗式(GAN/Generative/Adversarial)](#GAN)

### [8. 图像处理(Image Processing)](#ImageProcessing)
...
### [9. 三维视觉(3D Vision)](#3DVision)
* 三维点云(3D Point Cloud)<br>
* 三维重建(3D Reconstruction)<br>

### [10. 神经网络架构(Neural Network Structure)](#NNS)
* Transformer<br>
* 图神经网络(GNN)<br>

### [11. 神经网络架构搜索(NAS)](#NAS)

### [12. 数据处理(Data Processing)](#DataProcessing)
* 数据增广(Data Augmentation)<br>
* 归一化/正则化(Batch Normalization)<br>
* 图像聚类(Image Clustering)<br>

### [13. 模型压缩(Model Compression)](#ModelCompression)
* 知识蒸馏(Knowledge Distillation)<br>

### [14. 模型评估(Model Evaluation)](#ModelEvaluation)

### [15. 数据集(Database)](#Database)

### [16. 主动学习(Active Learning)](#ActiveLearning)

### [17. 小样本学习(Few-shot Learning)](#Few-shotLearning)

### [18. 持续学习(Continual Learning/Life-long Learning)](#ContinualLearning)

### [19. 视觉推理(Visual Reasoning)](#VisualReasoning)

### [20. 迁移学习/domain/主动学习/自适应](#domain)
...
PML: Progressive Margin Loss for Long-tailed Age Classification(长尾年龄分类的累进边际损失)<br>
