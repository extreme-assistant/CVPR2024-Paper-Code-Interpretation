...
* [人脸生成/合成/重建/伪造/编辑(Face Generation/Face Synthesis/Face Reconstruction/Face Forgery/Face Editing)](#FaceSynthesis)
...
[10] DSC-PoseNet: Learning 6DoF Object Pose Estimation via Dual-scale Consistency(通过双尺度一致性学习6DoF对象姿势估计)<br>
[paper](https://arxiv.org/abs/2104.03658)<br><br>

[9] Learning optical flow from still images(从静止图像中学习光流)<br>
...
[11] Riggable 3D Face Reconstruction via In-Network Optimization(通过网络内优化进行可操纵的3D人脸重建)<br>
...
SOLD2: Self-supervised Occlusion-aware Line Description and Detection(自我监督的遮挡感知线描述和检测)<br>
