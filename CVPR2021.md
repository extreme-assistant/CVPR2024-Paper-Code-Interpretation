...
### [6. 图像/视频检索(Image Retrieval)](#ImageRetrieval)
...
### [文本检测/识别(Text Detection/Recognition)](#TDR)

### [8. 遥感图像(Remote Sensing Image)](#RSI)

### [9. GAN/生成式/对抗式(GAN/Generative/Adversarial)](#GAN)


### [11. 三维视觉(3D Vision)](#3DVision)
* [三维点云(3D Point Cloud)](#3DPC)<br>
* [三维重建(3D Reconstruction)](#3DReconstruction)<br>

### [12. 神经网络架构(Neural Network Structure)](#NNS)
* [Transformer](#Transformer)<br>
* [图神经网络(GNN)](#GNN)<br>

### [13. 神经网络架构搜索(NAS)](#NAS)

### [14. 数据处理(Data Processing)](#DataProcessing)
...
### [16. 模型评估(Model Evaluation)](#ModelEvaluation)

### [17. 数据集(Database)](#Database)

### [18. 主动学习(Active Learning)](#ActiveLearning)

### [19. 小样本/零样本学习(Few-shot/Zero-shot Learning)](#Few-shotLearning)

### [20. 持续学习(Continual Learning/Life-long Learning)](#ContinualLearning)

### [21. 视觉推理(Visual Reasoning)](#VisualReasoning)

### [22. 迁移学习/domain/自适应](#domain)

### [23. 对比学习(Contrastive Learning)](#ContrastiveLearning)

### [24. 强化学习(Reinforcement Learning)](#RL)
