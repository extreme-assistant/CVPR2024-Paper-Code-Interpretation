...
* [图像分割(Image Segmentation)](#ImageSegmentation)<br>
...
* [密集预测(Dense Prediction)](#DensePrediction)<br>
...
* [人脸合成/伪造(Face Synthesis/Face Forgery)](#FaceSynthesis)
...
### [8. 神经网络架构(Neural Network Structure)](#NNS)
...
### 人脸合成/伪造(Face Synthesis/Face Forgery)
...
[paper](https://arxiv.org/abs/2103.05465)<br><br>
...
[33] Knowledge Evolution in Neural Networks(神经网络中的知识进化)<br>
[paper](https://arxiv.org/pdf/2103.05152.pdf) | [code](https://github.com/ahmdtaha/knowledge_evolution)<br><br>

[32] NeX: Real-time View Synthesis with Neural Basis Expansion(NeX：具有神经基础扩展的实时视图合成)<br>
[paper](https://arxiv.org/abs/2103.05606) | [code](https://nex-mpi.github.io/)<br><br>

[31] ForgeryNet: A Versatile Benchmark for Comprehensive Forgery Analysis(进行全面伪造分析的多功能基准)<br>
[paper](https://arxiv.org/abs/2103.05630) | [code](https://yinanhe.github.io/projects/forgerynet.html)<br><br>

[30] Dense Contrastive Learning for Self-Supervised Visual Pre-Training(自监督视觉预训练的密集对比学习)<br>
[paper](https://arxiv.org/abs/2011.09157) | [code](https://github.com/WXinlong/DenseCL)<br><br>
