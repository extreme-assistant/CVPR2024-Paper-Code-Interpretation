...
* [人脸生成/合成/伪造/编辑(Face Generation/Face Synthesis/Face Forgery/Face Editing)](#FaceSynthesis)
...
### [23. 数据处理(Data Processing)](#DataProcessing)
...
### [24. 主动学习(Active Learning)](#ActiveLearning)

### [25. 小样本学习/零样本学习/元学习(Few-shot/Zero-shot Learning)](#Few-shotLearning)

### [26. 持续学习(Continual Learning/Life-long Learning)](#ContinualLearning)

### [27. 迁移学习/domain/自适应(Transfer Learning/Domain Adaptation)](#domain)

### [28. 度量学习(Metric Learning)](#MetricLearning)

### [29. 对比学习(Contrastive Learning)](#ContrastiveLearning)

### [30. 强化学习(Reinforcement Learning)](#RL)

### [31. 元学习(Meta Learning)](#MetaLearning)

### [32. 数据集(Dataset)](#Dataset)
...
[8] Learning Optical Flow from a Few Matches(通过少量匹配学习光流)<br>
[paper](https://arxiv.org/abs/2104.02166) | [code](https://github.com/zacjiang/scv)<br><br>

[7] FESTA: Flow Estimation via Spatial-Temporal Attention for Scene Point Clouds(FESTA：场景点云通过时空注意进行光流估计)<br>
[paper](https://arxiv.org/abs/2104.00798)<br><br>

[6] Wide-Depth-Range 6D Object Pose Estimation in Space(空间中的深度范围6D对象姿态估计)<br>
...
[2] ArtFlow: Unbiased Image Style Transfer via Reversible Neural Flows(通过可逆神经流进行无偏的图像风格迁移)<br><br>
...
[10] Everything's Talkin': Pareidolia Face Reenactment(一切都在说话'：帕累多利亚脸部重现)<br>
[paper](https://arxiv.org/abs/2104.03061) | [project](https://wywu.github.io/projects/ETT/ETT.html)

[9] Face Forensics in the Wild(人脸伪造数据集)<br>
[paper](https://arxiv.org/abs/2103.16076) | [paper](https://github.com/tfzhou/FFIW)<br><br>

[8] High-Fidelity and Arbitrary Face Editing(高保真和任意脸部编辑)<br>
...
[paper](https://arxiv.org/abs/2103.14635) | [code](https://github.com/CVMI)<br><br> 
...
[paper](https://arxiv.org/abs/2104.00990) | [code&dataset](http://vidsitu.org/)<br><br>

[6] Face Forensics in the Wild(人脸伪造数据集)<br>
[paper](https://arxiv.org/abs/2103.16076) | [code&dataset](https://github.com/tfzhou/FFIW)<br><br>
...
SGCN:Sparse Graph Convolution Network for Pedestrian Trajectory Prediction(【自动驾驶】【行人轨迹预测】SGCN：行人轨迹预测的稀疏图卷积网络)<br>
...
Looking into Your Speech: Learning Cross-modal Affinity for Audio-visual Speech Separation(观察您的语音：学习跨模态亲和力以进行视听语音分离)<br>
[paper](https://arxiv.org/abs/2104.02775) | [project](https://caffnet.github.io/)<br><br>

Localizing Visual Sounds the Hard Way(【视听】视觉声音定位的困难方法)<br>
[paper](https://arxiv.org/abs/2104.02691)<br><br>

Can audio-visual integration strengthen robustness under multimodal attacks?(【视听】视听集成能否增强多模式攻击下的鲁棒性？)<br>
[paper](https://arxiv.org/abs/2104.02000)<br><br>

Cyclic Co-Learning of Sounding Object Visual Grounding and Sound Separation(【视听】探测对象视觉接地与声音分离的循环共同学习)<br>
[paper](https://arxiv.org/abs/2104.02026)<br><br>

Positive Sample Propagation along the Audio-Visual Event Line(【视听】沿视听事件线的正样本传播)<br>
[paper](https://arxiv.org/abs/2104.00239) | [code](https://github.com/jasongief/PSP_CVPR_2021)<br><br>

LaPred: Lane-Aware Prediction of Multi-Modal Future Trajectories of Dynamic Agents(【车道线预测】动态代理的多模态未来轨迹的车道感知预测)<br>
...
Few-Shot Incremental Learning with Continually Evolved Classifiers(【增量学习】借助不断发展的分类器进行少量增量学习)<br>
[paper](https://arxiv.org/abs/2104.03047)<br><br>

DER: Dynamically Expandable Representation for Class Incremental Learning(【增量学习】用于类增量学习的动态可扩展表示形式)<br>
...
Multimodal Motion Prediction with Stacked Transformers(【多模态预测】堆叠式Transformer的多模态运动预测)<br>
...
Video Prediction Recalling Long-term Motion Context via Memory Alignment Learning(【视频预测】通过记忆对准学习的视频预测调用长期运动环境)<br>
[paper](https://arxiv.org/abs/2104.00924)<br><br>

MotionRNN: A Flexible Model for Video Prediction with Spacetime-Varying Motions(【视频预测】针对复杂时空运动的通用视频预测模型)<br>
